...
STUNAME DB ALL*NAMELEN DUP('?')
STUCLASS DB ALL DUP('?')
STUNUMBER DB ALL DUP('?')
STUSCORE DB ALL*SCORELEN DUP('?')
...
CR = 0DH
LF = 0AH
TABLE DW CASE1,CASE2,CASE3,CASE4,CASE5,ERROR

ADDNAME DB 'student name:',0DH,0AH,'$'
ADDCLASS DB 'student class:',0DH,0AH,'$'
ADDNUMBER DB 'student number:',0DH,0AH,'$'
ADDSCORE DB 'student score:',0DH,0AH,'$'
